...
public class Topping
	{
		...
		{
			object ttObject = allowedToppingTypes.First(tt => (string)tt.GetType().GetProperty("ToppingType").GetValue(tt, null) == this.ToppingType.ToLower());
			double ttModifier = (double)ttObject.GetType().GetProperty("CaloriesModifier").GetValue(ttObject, null);
